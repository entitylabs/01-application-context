...
public class Application {
	...
	public static void main(String[] args) {
		...
		/**
		 * Try with resource to ensure proper closure of context
		 */
		try (var applicationContext = new ClassPathXmlApplicationContext("classpath:/beans/beans1.xml", "beans2.xml")) {
